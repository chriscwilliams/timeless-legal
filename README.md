...
Open the app once to refresh today's verse. The notification updates each 
time the app is opened.

**How do I change my notification time?**
Open any proverb card → tap the ••• menu → scroll to Settings → Daily Reminder.

**How do I create a collection?**
Go to the Collections tab → tap the + button in the top right corner.

**How do I add a note to a proverb?**
...
Scripture quotations are from the World English Bible, a Public Domain translation.

**King James Version (KJV)**
Scripture quotations from the King James Version are in the Public Domain.
